    ...
    parser.hooks = hashMapOf(
        ...
        "help" to { _, e ->
            e.channel.sendMessage(EmbedBuilder()
                ...
                .setDescription("Different commands for the raidtool bot")
                ...
                .addField("${botConfig.prefix}schedule cancel <days>", "Cancels a day/days", false)
                .addField("${botConfig.prefix}schedule add <days>", "Books additional days", false)
